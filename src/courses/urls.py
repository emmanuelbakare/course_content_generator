...
from .views import CourseCreateView, CourseDetailView, CourseListView, CourseWorkspaceView, CurriculumReviewView, LessonRevisionCreateView, ManualCurriculumRevisionView
